...
package xin.dbpay.channel.demo.web.controller;
...
import xin.dbpay.channel.demo.dao.ApyAccountRepository;
import xin.dbpay.channel.demo.entity.ApyAccount;
import xin.dbpay.channel.demo.entity.PayType;
import xin.dbpay.channel.demo.web.request.QueryOrder;
import xin.dbpay.channel.demo.service.ApyAccountService;
import xin.dbpay.channel.demo.service.PayResponse;
...
import xin.dbpay.channel.provider.spi.api.*;
import xin.dbpay.channel.provider.spi.bean.*;
import xin.dbpay.channel.provider.spi.http.UriVariables;
import xin.dbpay.channel.provider.spi.util.MatrixToImageWriter;
import xin.dbpay.channel.provider.spi.util.str.StringUtils;
...
public class PayController {
    ...
    public String index(Model model) {
        model.addAttribute("title", "DBPay Demo");
        return "index";
    }
